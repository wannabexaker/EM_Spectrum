...
export const F_MIN = 1      // 1 Hz — hard left edge, nothing below
export const F_MAX = 1e26   // 10^26 Hz — hard right edge
export const LOG_MIN = 0    // log10(1 Hz)
export const LOG_MAX = 26   // log10(1e26 Hz)
export const LOG_RANGE = LOG_MAX - LOG_MIN  // 26 decades
...
export function formatFrequency(hz: number): string {
  if (hz < 1) return `${hz.toPrecision(3)} Hz`
